...
// FAQPage JSON-LD intentionally lives on /faq (the canonical destination).
// Duplicating it here would split rich-snippet eligibility between two URLs
// and dilute the signal Google uses to choose which page to surface.
export function Faq() {
